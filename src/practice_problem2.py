...
def run_test_practice_problem2a():
    ...
    actual = practice_problem2a([2, 10, 5, -20, 14], 6)
    print("Expected:", expected)
    print("Actual:  ", actual)

    expected = [0, 0, 0, 0, 0]
    actual = practice_problem2a([1, 1, 1, 1, 1], -1)
    print("Expected:", expected)
    print("Actual:  ", actual)

    expected = []
    actual = practice_problem2a([], -1)
    print("Expected:", expected)
    print("Actual:  ", actual)

    expected = [0]
    actual = practice_problem2a([-100], 100)
    print("Expected:", expected)
    print("Actual:  ", actual)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        string = sequence[k]
        if string != '':
            return_string = return_string + string[0]
